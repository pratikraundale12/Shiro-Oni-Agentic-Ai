...
`;
const RegistryCreateUpgradeCredsModal = ({
  registryType,
  register,
  errors,
  openAddConfigModal,
  ...
  return (
    <>
      <Modal
        ...
        primaryButtonText={'Initiate Registry Creation'}
        primaryButtonDisabled={
          registryType === 'aks' ? !azureTestPassed : false
        }
        onRequestClose={onRequestClose}
        onSubmit={handleSubmit(handleCreateRegistry, onError)}
        onSecondarySubmit={onRequestClose}
        footerAlign="start"
        contentStyles={{ minWidth: '60%', maxHeight: '60%' }}
        tertiaryButton={registryType === 'aks'}
...
export default RegistryCreateUpgradeCredsModal;

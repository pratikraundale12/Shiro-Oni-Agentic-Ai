...
const RegistryMultiSelect = ({
  ...
  const customStyles = {
    ...
    control: (styles, state) => {
      ...
      else newStyles.borderColor = theme.colors.darkGrey2;
          ...
          const selectProps = {
            ...
            onChange: (selected, meta) => {
              if (isFunction(customOnChange)) {
                customOnChange(onChange, selected, { ...meta, name });
              } else {
                onChange(selected);
              }
            },
...
RegistryMultiSelect.defaultProps = {
  errors: {},
  label: '',
  required: false,
...
export default RegistryMultiSelect;

...
export const CLUSTER_ANSIBLE_DEFAULT_CONFIGURATION_VALUE = {
  ...
  nifi_authorizer_configuration_file: '{{nifi_config_dir}}/authorizers.xml',
  ...
  nifi_flow_configuration_archive_dir: '{{nifi_internal_dir}}/archive/',
  ...
  nifi_flow_configuration_file: '{{nifi_flow_config_dir}}/flow.xml.gz',
  nifi_flowcontroller_graceful_shutdown_period: '10 sec',
  nifi_flowfile_repository_checkpoint_interval: '2 mins',
  nifi_flowfile_repository_directory: '{{nifi_flowfile_repo_dir}}',
  ...
  nifi_nar_library_autoload_directory: '{{nifi_internal_dir}}/work/extensions',
  nifi_nar_library_directory: '{{nifi_install_dir}}/lib',
  nifi_nar_working_directory: '{{nifi_internal_dir}}/work/nar',

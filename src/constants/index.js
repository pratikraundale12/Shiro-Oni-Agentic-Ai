...
import { REGISTRY_CONSTANTS } from './registry.constants';
...
export const ACTIVITY_EVENTS = [
  ...
  { label: 'Schedule Stopped', value: 'Schedule stopped' },
  ...
  { label: 'Stop Cluster', value: 'Stop Cluster' },
  { label: 'Add Node', value: 'Add Node' },
  { label: 'Create Registry', value: 'Create Registry' },
  { label: 'Start', value: 'Start' },
  { label: 'Creation', value: 'creation' },
  { label: 'Add Config', value: 'Add Config' },
  {
    label: 'Add Kubernetes Configuration',
    value: 'Add Kubernetes Configuration',
  },
  {
    label: 'Add Registry Configurartion',
    value: 'Add Registry Configurartion',
  },
  { label: 'Download Certificates', value: 'Download Certificates' },
  { label: 'Driver Upload ', value: 'Driver Upload' },
  { label: 'Driver Delete', value: 'Driver Delete' },
  { label: 'Nar Upload', value: 'Nar Upload' },
  { label: 'Nar Delete', value: 'Nar Delete' },
  { label: 'Script Upload', value: 'Script Upload' },
  { label: 'Delete Config', value: 'Delete Config' },
  {
    label: 'Delete Kubernetes Configuration',
    value: 'Delete Kubernetes Configuration',
  },

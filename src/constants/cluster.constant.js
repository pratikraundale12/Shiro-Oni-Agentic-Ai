export const CLUSTER_CONSTANTS = {
  ...
  PFX_FILE_SIZE: '3.7KB',
  PFX_FILE: 'Certificate File',
  PFX_PASSPHRASE: 'Certificate Passphrase',
  SELECT_PFX_FILE: 'Select your Certificate File',
  ENTER_PFX_PASSPHRASE: 'Enter your Certificate Passphrase',
  ...
  TEST_CERTIFICATE: 'Add Certificate',
  ...
  MANAGE_EXISTING_CLUSTER_DESCRIPTION: 'Register an existing cluster in DFM',

...
export const CurvedSSOLoginIcon = ({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M12.65 16.1C12.46 16.1 12.27 16.03 12.12 15.88C11.83 15.59 11.83 15.11 12.12 14.82L14.94 12L12.12 9.18003C11.83 8.89003 11.83 8.41003 12.12 8.12003C12.41 7.83003 12.89 7.83003 13.18 8.12003L16.53 11.47C16.82 11.76 16.82 12.24 16.53 12.53L13.18 15.88C13.03 16.03 12.84 16.1 12.65 16.1Z"
        fill={color}
      />
    </svg>
  );

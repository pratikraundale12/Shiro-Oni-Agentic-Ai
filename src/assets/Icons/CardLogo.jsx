...
const RotatingGroup = styled.g`
  ...
  /* If enabled, target this group when the parent 
     svg (represented by the first argument of the component) is hovered 
  */
  ${({ $enableHoverRotation }) =>
    $enableHoverRotation &&
    `
...
CardLogo.propTypes = {
  ...
  enableHoverRotation: PropTypes.bool,
};
